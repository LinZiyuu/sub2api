...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	accountConnectivityProbeResultRepository := repository.NewAccountConnectivityProbeResultRepository(db)
	accountConnectivityProbeService := service.ProvideAccountConnectivityProbeService(accountRepository, accountConnectivityProbeResultRepository, accountTestService, configConfig)
	v := provideCleanup(client, redisClient, opsMetricsCollector, opsAggregationService, opsAlertEvaluatorService, opsCleanupService, opsScheduledReportService, opsSystemLogSink, soraMediaCleanupService, schedulerSnapshotService, tokenRefreshService, accountExpiryService, subscriptionExpiryService, usageCleanupService, idempotencyCleanupService, pricingService, emailQueueService, billingCacheService, usageRecordWorkerPool, subscriptionService, oAuthService, openAIOAuthService, geminiOAuthService, antigravityOAuthService, openAIGatewayService, scheduledTestRunnerService, accountConnectivityProbeService, backupService)
